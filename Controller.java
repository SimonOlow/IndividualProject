...
Scanner scan = new Scanner(System.in);
	...
	String filePath = "src/todolist/todolist.csv";
	String tempPath = "src/todolist/todolist.csv";
	File mainFile = new File(filePath);
	File temp = new File("src/todolist/Temp.csv");
	int howManyDone = 0;
...
public void printWelcome() {
		...
		String line = ">> You have " + size + " tasks todo and " + howManyDone + " tasks are done!";
...
public void printChangeMenu() {
	...
	public void play() {
		...
		fileToArrayList(filePath, tasks);
		howManyDoneMethod();
